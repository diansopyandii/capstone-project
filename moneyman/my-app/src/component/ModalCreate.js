...
class ModalCreate extends React.Component {
  ...
  tambahItem() {
    ...
    const existingData = localStorage.getItem("transactionData");
    let transactions = [];
    if (existingData) {
      transactions = JSON.parse(existingData);
    }

    // Add new data to the existing transactions array
    ...
    // Call the action prop to update the summary in the parent component
        ...
        <Modal show={this.state.show} onHide={this.handleClose}>
          ...
          <Modal.Body>
            ...
            <div className="mb-3">
              ...
              <input type="date" className="form-control" placeholder="Masukkan Tanggal" name="tanggal" value={this.state.tanggal} onChange={this.handleChange} />
            </div>
          </Modal.Body>
          <Modal.Footer>
